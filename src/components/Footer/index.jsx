...
const Footer = () => (
        <div className="min-h-[300px] w-full bg-gray-900 flex flex-col justify-start items-center text-center pt-10 pb-5 md:pb-10">
            <div className="w-11/12 md:w-4/5 flex flex-col md:flex-row justify-center items-start" >
            {/* Copy rights  */}
            <section className="w-full md:w-1/3 flex flex-col justify-start items-start mb-8 md:mb-0 md:mr-10">
            ...
            {/* Let's Connect  */}
            <section className="w-full md:w-1/3  flex flex-col justify-center items-start mb-8 md:mb-0 md:mr-10">
                ...
                <div className='flex flex-row justify-start items-start mb-5'>
                    ...
                    className='bg-gray-800 p-3 rounded-full mr-5 text-gray-400 hover:bg-blue-800 hover:text-gray-100
