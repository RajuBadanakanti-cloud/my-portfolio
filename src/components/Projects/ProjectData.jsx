...
const PROJECTSLIST = [
        ...
        id:uuidv4(),
        category:"Full-Stack Development",
        title:"Spend Smart App",
        description:"Spend Smart App is a clean, intuitive web application that helps users track and manage their expenses effortlessly. With a simple interface, users can add, view, and categorize spending to gain clear insights into their finances. Designed for ease of use and responsive across devices, Spend Smart makes budgeting and money tracking quick and stress-free.",
        techStack:["HTML", "JavaScript", "React", "TailwindCSS", "Node", "Authentication","LocalStorage", "JWTToken" ,"Mongodb"],
        gitRepoLink:"https://github.com/RajuBadanakanti-cloud/spend-smart.git",
